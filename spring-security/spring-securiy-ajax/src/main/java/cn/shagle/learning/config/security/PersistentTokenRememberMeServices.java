package cn.shagle.learning.config.security;

import cn.shagle.learning.config.AppProperties;
import cn.shagle.learning.domain.PersistentToken;
import cn.shagle.learning.repository.PersistentTokenRepository;
import cn.shagle.learning.repository.UserRepository;
import cn.shagle.learning.util.RandomUtil;
...
public class PersistentTokenRememberMeServices extends
    ...
    public PersistentTokenRememberMeServices(AppProperties ppProperties,
                                             org.springframework.security.core.userdetails.UserDetailsService userDetailsService,
                                             PersistentTokenRepository persistentTokenRepository, UserRepository userRepository) {

        super(ppProperties.getSecurity().getRememberMe().getKey(), userDetailsService);
